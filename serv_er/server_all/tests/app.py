...
from serv_er.src.models import User, Twitt, db, Media, Likes, Followers
...
def create_app():
    followed_list = []
    following_list = []
    ABSOLUTE_PATH = ("home/a/PycharmProjects/python_advanced_diploma/"
                     "serv_er/server_all/tests/")
