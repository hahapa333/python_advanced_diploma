    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'complex', 'delattr', 'dist', 'dir', 'divmod', 'enumerate', 'eval',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'cmp', 'coerce', 'compile', 'complex', 'delattr', 'dist', 'dir', 'divmod',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'dist', 'dir', 'divmod', 'enumerate', 'eval', 'execfile', 'exit',
...
class DgLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (words((
                'bool', 'bytearray', 'bytes', 'classmethod', 'complex', 'dist', 'dist\'',
