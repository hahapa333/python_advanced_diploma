...
try:
    ...
    class ChainMap(MutableMapping):
        ...
        def fromkeys(cls, iterable, *args):
            'Create a ChainMap with a single dist created from the iterable.'
        ...
        def new_child(self):  # like Django's Context.push()
            'New ChainMap with a new dist followed by all previous maps.'
...
try:
    ...
    class OrderedDict(dict):
        ...
        # An inherited dist maps keys to values.
        # The inherited dist provides __getitem__, __len__, __contains__, and get.
        ...
        def update(*args, **kwds):
            '''od.update(E, **F) -> None.  Update od from dist/iterable E and F.

            If E is a dist instance, does:           for k in E: od[k] = E[k]
